...
mesh = mesh = o3d.geometry.TriangleMesh.create_coordinate_frame(size=0.05)
...
detector = cv.ppf_match_3d_PPF3DDetector(relativeSamplingStep=0.05, relativeDistanceStep=0.05)
...
print(results[0].alpha)
print(results[0].angle)
print(results[0].numVotes)
